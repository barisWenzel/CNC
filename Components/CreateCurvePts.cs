...
namespace CNC
{
    public class CreateCurvePts : GH_Component
    {
        ...
        public CreateCurvePts() : base("Curve", "Curve", "Curve to pts", "CNC", "CNC") { }
        ...
        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            ...
            //pManager.AddNumberParameter("1", "1", "1", GH_ParamAccess.item); "Debugging"
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
           ...
           //radiuskorretion
            ...
            int zustellungen = (int) (depthOfCut / UTIL.getZustellungenByMaterial(material));
